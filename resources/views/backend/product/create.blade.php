                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" class="form-control" placeholder="Write som text ..." name="description">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" max="100" step="any" class="form-control" placeholder="Price"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <select  id="cat_id" name="cat_id" class="form-control show-tick">
                                            ...
                                            @foreach (\App\Models\Category::where('is_parent', 1)->get() as $cat)
                                                <option value="{{ $cat->id }}" {{old('cat_id') == $cat->id ? 'selected' : ''}}>{{ $cat->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <select name="vendor_id" class="form-control show-tick">
                                            ...
                                            @foreach (\App\Models\User::where('role', 'vendor')->get() as $vendor)
                                                <option value="{{ $vendor->id }}" {{old('vendor_id') == $vendor->id ? 'selected' : ''}}>{{ $vendor->full_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
