                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" class="form-control" placeholder="Write som text ..." name="description">{{ $product->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" max="100" step="any"
                                                class="form-control" placeholder="Price" name="discount"
