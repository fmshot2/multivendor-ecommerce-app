                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-6">
                            <div class="welcome_slide_text">
                                <h2 class="" data-animation="fadeInUp" data-delay="300ms">{{$banner->title}}</h2>
                                <h4 class="" data-animation="fadeInUp" data-delay="600ms">{!! html_entity_decode($banner->description) !!}</h4>
                                <a href="{{$banner->slug}}" class="btn btn-primary" data-animation="fadeInUp"
                                    data-delay="900ms">Shop Now</a>
                            </div>
                        </div>
                        <div class="col-12 col-md-5 single_slide bg-img" style="background-image: url({{$banner->photo}}); background-size: 900px;
