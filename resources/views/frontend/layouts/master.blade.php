...
<body>
                                            ...
                                            <div class="single-mega cn-col-2">
                                                <div class="megamenu-slides owl-carousel">
                                                    <a href="shop-grid-left-sidebar.html">
                                                        <img src="frontend/img/bg-img/mega-slide-2.jpg"
                                                            alt="">
                                                    </a>
                                                    <a href="shop-list-left-sidebar.html">
                                                        <img src="frontend/img/bg-img/mega-slide-1.jpg"
                                                            alt="">
                                                    </a>
                                                </div>
                                            </div>
    ...
    <section class="welcome_area">
        <div class="welcome_slides owl-carousel">
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(frontend/img/bg-img/8.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-5 col-md-4">
                            <div class="welcome_slide_image">
                                <img src="frontend/img/bg-img/slide-1.png" alt="" data-animation="bounceInUp"
                                    data-delay="500ms">
            ...
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(frontend/img/bg-img/7.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
            ...
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(frontend/img/bg-img/6.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    <div class="quickview_pro_img">
                                        <img class="first_img" src="frontend/img/product-img/new-1-back.png"
                                            alt="">
                                        <img class="hover_img" src="frontend/img/product-img/new-1.png"
                                            alt="">
                                        <!-- Product Badge -->
                                ...
                                <div class="best_rated_area">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/best-3.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Women Watch</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/best-4.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Headphone</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/best-5.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Plus Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/best-6.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Laptop</h5>
                                ...
                                <div class="on_sale_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/onsale-1.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Speaker</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/onsale-2.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Fancy Lamp</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/onsale-3.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sport Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/onsale-4.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>S'well Water</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/onsale-5.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Slipper</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="frontend/img/product-img/onsale-6.png"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>T-shirt</h5>
                ...
                <div class="col-12 col-md-7 col-lg-8 col-xl-3">
                    ...
                    <div class="single_footer_area mb-100">
                        ...
                        <div class="apps_download">
                            <a href="#"><img src="frontend/img/core-img/play-store.png"
                                    alt="Play Store"></a>
                            <a href="#"><img src="frontend/img/core-img/app-store.png"
                                    alt="Apple Store"></a>
                        </div>
                    </div>
                </div>
