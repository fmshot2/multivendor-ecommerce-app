        ...
        <div class="classy-nav-container breakpoint-off">
            <nav class="classy-navbar" id="bigshopNav">
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            <li class="cn-dropdown-item has-down"><a href="{{ route('home') }}">Home</a>
                                <ul class="dropdown">
                ...
                <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                                        ...
                                        <div class="cart-item-desc">
                                            <a href="#" class="image">
                                                <img src="{{ $item->model->photo }}" class="cart-thumb"
                                                    {{-- <img src="{{$item->model-}}frontend/img/product-img/top-1.png" class="cart-thumb" --}} alt="">
                                            </a>
                                            <div>
                                                <a
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        @if (session()->has('coupon'))
                                            <span>${{filter_var(\Gloudemans\Shoppingcart\Facades\Cart::subtotal(), FILTER_SANITIZE_NUMBER_INT ) - session('coupon')['value'], 3 }}</span>
                                        @else
                                            <span>${{\Gloudemans\Shoppingcart\Facades\Cart::subtotal() }}</span>
                                        @endif
                    ...
                    <div class="account-area">
                        ...
                        <ul class="user-meta-dropdown">
                            ...
                            @else
                                {{-- <li class="user-title"><span>Hello,</span> Login & Register Sarah</li> --}}
